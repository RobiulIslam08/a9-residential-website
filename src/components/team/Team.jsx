...
const Team = () => {
    return (
        <div>
            <section className="lg:mb-20 mb-14  py-6 dark:bg-gray-100 dark:text-gray-800">
	<div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
		<p className="p-2 text-sm font-medium tracking-wider text-center uppercase">Our team</p>
		<h1 data-aos="zoom-in-up"  data-aos-delay="50"
    data-aos-duration="1000" className="text-4xl font-bold leading-none text-center sm:text-5xl">The talented people behind the scenes</h1>
		<div className="flex flex-row flex-wrap-reverse justify-center mt-8">
			<div  data-aos-delay="50"
    data-aos-duration="1000" data-aos="flip-up" className="flex flex-col justify-center w-full px-8  mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-800 dark:text-gray-100">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leading-snug">Jadeya Hosna</p>
					<p>Senior PM</p>
				</div>
    ...
    data-aos-duration="1000" data-aos="flip-up" className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-800 dark:text-gray-100">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leading-snug">Rahnat Sultana</p>
					<p>GM Officer</p>
				</div>
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="dark:text-gray-50 hover:dark:text-violet-600">
    ...
    data-aos-duration="1000" data-aos="flip-up" className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-800 dark:text-gray-100">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leading-snug">Alia Afifa</p>
					<p>Senior Gm</p>
				</div>
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="dark:text-gray-50 hover:dark:text-violet-600">
    ...
    data-aos-duration="1000" data-aos="flip-up" className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-800 dark:text-gray-100">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leading-snug">Saria Mim</p>
					<p>Marketing Offier</p>
				</div>
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="dark:text-gray-50 hover:dark:text-violet-600">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
    ...
    data-aos-duration="1000" data-aos="flip-up" className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-800 dark:text-gray-100">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leading-snug">Ahona Faria</p>
					<p>General Manager</p>
				</div>
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="dark:text-gray-50 hover:dark:text-violet-600">
